...
namespace Melodic.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231004022927_addBrandAndSpeakerTable")]
    partial class addBrandAndSpeakerTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Melodic.Domain.Entities.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Melodic.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
